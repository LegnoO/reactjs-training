              ...
              <div className="card shadow-lg">
                <div className="card-body p-5">
                  ...
                  {loading ? (
                    ...
                    <div className="mb-3">
                      <label className="mb-2 text-muted" htmlFor="email">Gmail</label>
                      <input {...register("gmail", { required: true })} id="text" type="email" className="form-control" name="gmail" required />
                      {errors.gmail && <span className='text-danger'>This field is required</span>}
                    </div>
                    <div className="mb-3">
